...
def windowForTextCipher():
    ...
    txtService = Entry(f1, font=('arial', 16, 'bold'), textvariable=Result, bd=10, insertwidth=4, width=30, bg="white",
                       justify='left')
...
def windowForImageCipher():
    ...
    # Column for Message Input
    txtReference = Entry(f1, font=('arial', 16, 'bold'), textvariable=Msg, bd=10, insertwidth=4, bg="white",
                         justify='left')
    txtReference.grid(row=0, column=1)
    ...
    resultMessage = Entry(f1, font=('arial', 16, 'bold'), textvariable=Result, bd=10, insertwidth=4, width=30,
